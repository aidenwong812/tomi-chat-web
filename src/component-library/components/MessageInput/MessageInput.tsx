...
export const MessageInput = ({
  ...
  return (
    <>
      ...
      <form className="p-2 border-t border-l border-[#FF0083] dark:border-[#000000] flex items-center bg-white dark:bg-[#111111] rounded-tl-3xl justify-between ml-[14px]">
          ...
          {attachmentError ? (
            ...
            <div className="flex flex-row justify-between items-center">
              <textarea
                ...
                className={classNames(
                  textAreaStyles,
                  "border-b-8 border-gray-50 m-0 bg-transparent text-black dark:text-white placeholder:text-[#FF0083] placeholder:dark:text-[#a2a2a2]",
        ...
        <div className="flex justify-between bg-transparent rounded-b-2xl gap-3 px-3">
          <div className="flex flex-row">
            <PhotographIcon
              tabIndex={0}
              width={24}
              height={24}
              className="m-2 cursor-pointer text-[#FF0083] dark:text-[#A6ADB5] hover:text-[#ff65b5] focus:outline-none focus-visible:ring"
            ...
            {status !== "recording" ? (
              ...
              <StopIcon
                ...
                width={24}
                height={24}
                className="m-2 cursor-pointer text-gray-400 hover:text-[#ff65b5] focus:outline-none focus-visible:ring"
                onClick={() => {
                  stopRecording();
                  pause();
                  reset();
